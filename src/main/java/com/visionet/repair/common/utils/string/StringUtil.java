package com.visionet.repair.common.utils.string;
...
//	}
    ...
    public static int getRandomNumber(int begin,int end){
        ...
        return random.nextInt(len) + begin;
    }
	...
	//解析超链接http://view.inews.qq.com/w/WXN20140524004375041?refer=nwx&mmuin=1544283460&groupid=1400893830&msgid=3&isappinstalled=0
	public static String convert2Link(String str){
		if(str!=null&&!"".equals(str)){
			...
			while(str.indexOf("http")!=-1){
				...
				temp.append(str.substring(0,start)).append("<a href=\""+str.substring(start,end)+"\" target=\"_blank\">"+str.substring(start,end)+"</a>");
...
//		String str = "解析超链接http://view.inews.qq.com/w/WXN20140524004375041?refer=nwx&mmuin=1544283460&groupid=1400893830&msgid=3&isappinstalled=0 呆右要楞在要要不http://www.baidu.com";
//		System.out.println(StringUtil.convert2Link(str));
//        System.out.println(ToUpperCaseFirstOne("paramData"));
